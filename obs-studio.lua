...
local function updateConfiguration ()
    ...
    updateBrowserSource("Caller-1-Camera-VDON",  url .. "/C1/camera")
    updateBrowserSource("Caller-1-Content-VDON", url .. "/C1/content")
    updateBrowserSource("Caller-2-Camera-VDON",  url .. "/C2/camera")
    updateBrowserSource("Caller-2-Content-VDON", url .. "/C2/content")
    updateBrowserSource("Caller-3-Camera-VDON",  url .. "/C3/camera")
    updateBrowserSource("Caller-3-Content-VDON", url .. "/C3/content")
    updateBrowserSource("Caller-4-Camera-VDON",  url .. "/C4/camera")
    updateBrowserSource("Caller-4-Content-VDON", url .. "/C4/content")
    updateBrowserSource("Caller-5-Camera-VDON",  url .. "/C5/camera")
    updateBrowserSource("Caller-5-Content-VDON", url .. "/C5/content")
    updateBrowserSource("Caller-6-Camera-VDON",  url .. "/C6/camera")
    updateBrowserSource("Caller-6-Content-VDON", url .. "/C6/content")
    updateBrowserSource("Caller-7-Camera-VDON",  url .. "/C7/camera")
    updateBrowserSource("Caller-7-Content-VDON", url .. "/C7/content")
    updateBrowserSource("Caller-8-Camera-VDON",  url .. "/C8/camera")
    updateBrowserSource("Caller-8-Content-VDON", url .. "/C8/content")
end
